...
export default function nav() {
  return (
    <div className="flex bg-green-800 absolute p-2 top-0 left-0 z-10 w-full">
      <div className="flex w-full h-12 text-green-200 uppercase ">
        <Link className="flex w-full items-center" href="/">
          <svg fill="#bbf7d0" viewBox="0 0 24 18" className="px-2 w-10 h-10">
        ...
        <Link
          className="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-2 focus:outline-none focus:ring-green-300 shadow-green-500/50 font-medium rounded-l-2xl text-sm px-8 py-2.5 text-center mb-2"
          href="/"
        >
          <span className="p-1 text-sm">Home</span>
        </Link>
        <div className="text-green-200 border-r-2 border-t-2 border-b-2 border-green-300 focus:ring-2 focus:outline-none focus:ring-green-300 shadow-green-500/50 font-medium rounded-r-2xl text-sm px-5 py-2.5 text-center me-2 mb-2">
