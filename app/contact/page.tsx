    ...
    <>
      ...
      <div className="">
        <div className="p-6 md:p-10 mt-6 lg:mx-96">
          <div className="flex border shadow-lg shadow-green-800/20  rounded-xl p-8 items-center mt-10">
            <BuildingOfficeIcon className="size-8 w-16 text-teal-500 " />
            <p className="ml-10 md:border-l-2 pl-4"> Sky Growers Limited</p>
          </div>

          <a
            className="group flex border shadow-lg shadow-green-800/20 hover:shadow-xl hover:shadow-green-800/20 hover:ml-1 rounded-xl p-8 items-center mt-10 w-full"
